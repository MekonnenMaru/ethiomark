...
<div style="display:none;" class="bonus-notification" id="bonusNotification">
	...
	<div class="confetti"></div>
			...
			<!-- ========================================================================== -->
					...
					<p id="new_bonus_chance" hidden style="font-size:50px;"><?php echo in_array($cashier_id, ["@temp11","1104.c1", "1104.c2", "1104.c3", "1104.c4"]) ? "5" : "3"; ?> </p>
					<p id="bonusCutSize_tobe_locked" hidden style="font-size:50px;"><?php echo in_array($cashier_id, ["@temp1","1104.c1", "1104.c2", "1104.c3", "1104.c4"]) ? "5" : ""; ?> </p>
...
<script type="text/javascript" >
						...
						else
						{
							...
							if(auto_check_result==="auto" )
							{
								...
								if (resp.win_status==1 && (resp.count_winning_line >= resp.expected_pattern))
								{
									...
									// to get bonus all the pattern must be gon
	...
	let new_bonus_chance = document.getElementById('new_bonus_chance').innerText;
	let bonusCutSize_tobe_locked = document.getElementById('bonusCutSize_tobe_locked').innerText;
	console.log("Chance ================ ",new_bonus_chance);
	console.log(" SBN Count ="+special_bonus_numbers.length + "  Status: "+ new_bonus_status+ "  SB Numbers: "+ special_bonus_numbers);
	///////////////////////////////////////////////////////////////
    ...
    if (n*s<=49) {
		...
		let bonusCutSize_tobe_locked = parseInt(document.getElementById('bonusCutSize_tobe_locked').innerText.trim(), 10);
		let randomIndex = Math.floor(Math.random() * special_bonus_numbers.length);
		if (!isNaN(bonusCutSize_tobe_locked)) {
			randomIndex = bonusCutSize_tobe_locked;
		}
		special_bonus_numbers.splice(randomIndex, new_bonus_chance);
	}
